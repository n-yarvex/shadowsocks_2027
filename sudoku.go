...
func newPackedEncoder(password string)*packedEncoder{return&packedEncoder{password:password,layout:&asciiLayout{}}}
...
func newPackedDecoder(password string)*packedDecoder{return&packedDecoder{password:password,layout:&asciiLayout{}}}
...
func(w*wrappedConn)Write(p []byte)(int,error){return w.writer.Write(p)}
